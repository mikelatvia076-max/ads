    ...
    conn.oniceconnectionstatechange =
        () => {
            ...
            if (state === "checking") {
                ...
                // packet, a network switch) that recovers on its own
                // within a few seconds - jumping straight to "failed"
                // here was scaring people off calls that would have
                // reconnected fine. Only "failed" (below) is treated
                // as a real, non-recoverable failure.
                callStatusText.textContent =
                    "Reconnecting...";
